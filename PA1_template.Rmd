...
p1 = ggplot(data = correctedWeekdays, aes(x=as.numeric(as.character(Interval)), y=Steps), ordered=TRUE) + geom_line() + geom_point() +
  labs(x = "Month", y = " Total Number of Steps Taken Each Day, Weekdays")
p1
p2 = ggplot(data = correctedWeekends, aes(x=as.numeric(as.character(Interval)), y=Steps), ordered=TRUE) + geom_line() + geom_point()+
  labs(x = "Month", y = " Total Number of Steps Taken Each Day, Weekends")
p2

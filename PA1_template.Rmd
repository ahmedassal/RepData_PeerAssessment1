...
The maximum value is @ `r intervalOfMaxAverageStepsNo_Index ` and its value is `r intervalOfMaxAverageStepsNo_Value`
...
In this analysis, I will substitute the missing values with the mean value of that interval across all days in the study.
...
```{r Graph_of_mean_after_imputing, echo = TRUE}
...
ggplot(data = correctedSum, aes(x=as.Date(Date), y=Steps), ordered=TRUE) + geom_line() + geom_point()+
